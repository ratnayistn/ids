            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Tambah Data Customer Baru 2</h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                          <div class="col-md-12">
                            <form action="/customer/create2" method='POST' class="form-group">
                              @csrf
                              ...
                              <select name="kota" class="form-control" id="kota">
                                ...
                                {{-- <option value="0" disabled="true" selected="true"> - Pilih Kota - </option> --}}
                                {{-- @foreach ( $kota as $kot )
                                <option value="{{ $kot->city_id }}">{{ $kot->city_name }}</option>
                                @endforeach --}}
                              </select>
                              ...
                              <select name="kecamatan" class="form-control" id="kecamatan">
                                ...
                                <option value="{{ $kec->dis_id }}">{{ $kec->dis_name }}</option>
                                @endforeach --}}
                              </select>
                              ...
                              <select name="kelurahan" class="form-control" id="kelurahan">
                                ...
                                <option value="{{ $kel->subdis_id }}">{{ $kel->subdis_name }}</option>
                                @endforeach --}}
                              </select>
                        ...
                        <input type="hidden" name="path" class="image-tag">
                        </div>
                        <div class="col-md-6">
      ...
      $.ajax({
        ...
        success:function (data) {
          ...
          $.each(data.data[0].data,function(list,subcategory){
            $('#subcategory').append('<option value="'+subcategory.city_id+'">'+subcategory.city_name+'</option>');
          })
        }
      })
    });
